import { Swiper, SwiperSlide } from 'swiper/react'; // برای Swiper
import 'swiper/css'; // استایل پایه
import 'swiper/css/navigation'; // استایل ناوبری
import 'swiper/css/thumbs'; // استایل تامب
                ...
                <div className="block w-full">
                    ...
                    <div className="text">
                        ...
                        <div className="block w-full mb-6">
                            ...
                            <div className="flex min-[400px]:grid-cols-3 gap-3">
                                <button
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-8">
                            <div className="flex items-center justify-center w-full">
                                ...
                                <input type="text"
                                    className="font-semibold !h-14 text-gray-900 text-lg py-[13px] px-6 w-full lg:max-w-[118px]  border-y !border-gray-400 bg-transparent !border-x-0 placeholder:text-gray-900 text-center hover:!bg-gray-50 focus-within:bg-gray-50 !rounded-none outline-0 !border-1"
                                    placeholder="1" />
                                <button
