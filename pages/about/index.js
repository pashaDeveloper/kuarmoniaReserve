...
function AboutUs() {
 ...
 <Main >
<HeaderSection />
<Container className={"max-w-full bg-blue-100 dark:bg-gray-900"}>
<Introduction />
<TeamSection />
    <CompanyResults />
  <UserTestimonials />
            ...
            <div className="bg-indigo-600 rounded-2xl p-8 xl:p-11">
                ...
                <div
                    ...
                    <input type="text" name="email"
                        className="py-2 px-6 bg-transparent border-none rounded-full max-lg:border border-gray-300  text-gray-100 max-lg:text-center placeholder:text-gray-400 focus:outline-none flex-1 w-full lg:w-auto lg:py-2 lg:px-6 lg:bg-transparent"
