  ...
  return (
    <section className="py-14 lg:py-24 ">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        modules={[Navigation]}
        navigation={{
          nextEl: ".swiper-button-next", // اتصال دکمه به Swiper
          prevEl: ".swiper-button-prev",
        }}
        breakpoints={{
          // حالت موبایل: یک اسلاید
          0: {
            slidesPerView: 1,
          },
          // حالت معمولی: دو اسلاید
          768: {
            slidesPerView: 2,
          },
        }}
      >
        <div className="swiper teamswiper pb-10" w-full>
            ...
            <div className="swiper-slide">
              <div className="group w-full flex-wrap flex items-center gap-8 flex-col md:flex-row transition-all duration-500 p-8 lg:flex-nowrap">
                ...
                <div className="text-center lg:text-left lg:max-w-xs flex-1 flex flex-col justify-between">
                  ...
                  <p className="text-gray-500 leading-6 mb-7">
                    I’ve been lead designer for pagedone since the beginning of
                    it and enjoyed every bit.
                  </p>
