...
const ListMedia = () => {
  ...
  useEffect(() => {
    if (isLoading) {
      toast.loading("در حال دریافت دسته بندی...", { id: "media-loading" });
    }
  ...
  const openDeleteModal = (Media) => {
    setSelectedMedia(Media); // ذخیره کردن اسلاید انتخاب شده
            ...
            >
              <div className="col-span-10 lg:col-span-4 text-center flex items-center">
                ...
                <div className="py-2 flex justify-center items-center gap-x-2 text-right">
                  {Media?.bgImg.type === "image" ? (
                                     <Image
                                     src={Media?.bgImg?.url || "/placeholder.png"}
                                     height={100}
                                     width={100}
