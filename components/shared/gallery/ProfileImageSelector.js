      ...
      >
        <div className="flex flex-col gap-y-4 justify-center items-center">
          <label className="relative inline-flex cursor-pointer items-center">
            ...
            />
            <div className="peer flex h-8 justify-center items-center gap-4 rounded-lg bg-orange-600 after:absolute after:left-1 after:h-6 after:w-[154px] after:rounded-lg after:bg-white/40 after:transition-all after:content-[''] peer-checked:bg-orange-600 peer-checked:after:translate-x-full peer-focus:outline-none text-sm text-white">
              <span className="mr-auto w-[150px] text-center" onClick={() => handleGenderSelection("female")}>خانم</span>
              <span className="mr-auto w-[150px] text-center" onClick={() => handleGenderSelection("male")}>آقا</span>
            </div>
          </label>
